...
if (isset($_POST["submitEditComment"])) {
  if (editComment($_POST) > 0) {
    $_SESSION["editComment"] = "Comment updated successfully!";
  } else {
    $_SESSION["editComment"] = "Comment failed to update!";
  }
  $postId = $_GET["pid"];
...
<html lang="en">
  <head>
    ...
    <title>Sociotime | Edit Comment</title>
    <link
          ...
          <div class="card-body">
            ...
            <div class="mt-3 my-3">
              <form class="card-text comment-form" action="" method="post">
                <input type="hidden" name="commentId" value="<?= $_GET["cid"]; ?>">
                <div class="post-border">
                  <textarea rows="1" type="text" placeholder="Send a comment" name="comment" required><?= $comment["comment"]; ?></textarea>
                </div>
                <hr>
                <div class="d-flex justify-content-end">
                  <button type="submit" name="submitEditComment" class="comment-button-cream">Edit Comment</button>
                </div>
              </form>
            </div>
          </div>
