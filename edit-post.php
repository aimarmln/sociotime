...
if (isset($_POST["submitEditPost"])) {
  if (editPost($_POST) > 0) {
    $_SESSION["editPost"] = "Post updated successfully!";
  } else {
    $_SESSION["editPost"] = "Post failed to update!";
  }
...
<html lang="en">
  <head>
    ...
    <title>Sociotime | Edit Post</title>
    <link
            ...
            <div class="mt-3 my-3">
              <form class="card-text comment-form" action="" method="post">
                ...
                <div class="post-border">
                  <textarea rows="1" type="text" name="caption" required><?= $postDetail["caption"]; ?></textarea>
                </div>
                ...
                <hr>
                <div class="d-flex justify-content-end">
                  <button type="submit" name="submitEditPost" class="comment-button-cream">Edit Post</button>
                </div>
              </form>
            </div>
          </div>
